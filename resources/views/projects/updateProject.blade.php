...
@section('stylesheet')
     ...
     <link type="text/css" href="/css/admin/select2.css" rel="stylesheet">
@endsection
@section('header')
...
@section('content')
    <div class="col-md-12 col-sm-12">
                        <form id="test-form" action="/admin/p_update/{{encrypt($project->project_id)}}" method="post" enctype="multipart/form-data">
                            {!! csrf_field() !!}
    ...
    <script type="text/javascript">
        ...
        function addProject(src_code_path,srs_path) {
            ...
            $.ajax({
                ...
                success: function( msg ) {
                    console.log(msg);
                    window.location.replace('/admin/projectDetail/{{encrypt($project->project_id)}}');
                }
            });
        }
    </script>
