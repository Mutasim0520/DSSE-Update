                        ...
                        <figure class="list new-group">
                            ...
                            <form id="test-form" action="/p_update/{{encrypt($project->project_id)}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <select class="form-control select2" name="pm" multiple="multiple" data-placeholder="Select Project Manager"  id="pm" style="width: 100%;" require>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <select name="member" class="form-control select2" multiple="multiple" required="" data-placeholder="Select Project Member"  id="member" style="width: 100%;" required>
                                ...
                                <div class="col-md-6 form-group" id="finishContainer" style="display: none;">
                                    ...
                                    <input class="form-control" name="finishDate" type="text" id="finishDate" class="datepicker">
                                </div>
